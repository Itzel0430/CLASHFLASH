...
public class letra_t extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.letra_t);
        ...
        hm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //home
                Intent intent = new Intent(letra_t.this, MainActivity.class);
        ...
        btnAnterior.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(letra_t.this, letra_s.class);
                startActivity(intent);
            }
        });
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(letra_t.this,letra_u.class);
                startActivity(intent);
            }
        });
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.t_tortuga);
        btnAudio = findViewById(R.id.btnAudioT);
