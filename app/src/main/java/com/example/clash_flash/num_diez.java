...
public class num_diez extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.num_diez);
        ...
        inicio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //home
                Intent intent = new Intent(num_diez.this, MainActivity.class);
        ...
        btnAnterior.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(num_diez.this, num_nueve.class);
                startActivity(intent);
            }
        });
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.numero_10);
        btnAudio = findViewById(R.id.btnAudioDiez);
