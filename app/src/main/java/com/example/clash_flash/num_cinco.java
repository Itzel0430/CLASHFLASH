...
public class num_cinco extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.num_cinco);
        ...
        inicio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //home
                Intent intent = new Intent(num_cinco.this, MainActivity.class);
        ...
        btnAnterior.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(num_cinco.this, num_cuatro.class);
                startActivity(intent);
            }
        });
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(num_cinco.this,num_seis.class);
                startActivity(intent);
            }
        });
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.numero_5);
        btnAudio = findViewById(R.id.btnAudioCinco);
