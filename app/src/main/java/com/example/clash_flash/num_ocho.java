...
public class num_ocho extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.num_ocho);
        ...
        inicio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //home
                Intent intent = new Intent(num_ocho.this, MainActivity.class);
        ...
        btnAnterior.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(num_ocho.this, num_siete.class);
                startActivity(intent);
            }
        });
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(num_ocho.this,num_nueve.class);
                startActivity(intent);
            }
        });
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.numero_8);
        btnAudio = findViewById(R.id.btnAudioOcho);
