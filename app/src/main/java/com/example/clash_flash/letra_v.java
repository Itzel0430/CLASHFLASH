...
public class letra_v extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.letra_v);
        ...
        hm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //home
                Intent intent = new Intent(letra_v.this, MainActivity.class);
        ...
        btnAnterior.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(letra_v.this, letra_u.class);
                startActivity(intent);
            }
        });
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(letra_v.this,letra_w.class);
                startActivity(intent);
            }
        });
        ...
        btnAudio = findViewById(R.id.btnAudioV);
